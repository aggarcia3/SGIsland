...
{
    /// <summary>
    /// Partial implementation of <see cref="I2DCoherentNoiseGenerator"/> that generates fractal noise
    /// by adding together octaves of a base noise function.
    /// </summary>
    public abstract class Abstract2DCoherentNoiseGenerator : ScriptableObject, I2DCoherentNoiseGenerator
    {
        ///<inheritdoc/>
